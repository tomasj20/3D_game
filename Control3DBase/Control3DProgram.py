...
class GraphicsProgram3D:
    def __init__(self):
        ...
        self.view_matrix.look(Point(3.8, 0.3, 2.0), Point(0,0,0), Vector(0,1,0))
    ...
    def display(self):
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(3.0, 1.0, 0.0)
        self.model_matrix.add_scale(0.2, 2.5, 4.0)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
        self.model_matrix.pop_matrix()
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(1.2, 1.0, 2.0)
