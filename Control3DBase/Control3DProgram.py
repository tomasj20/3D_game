...
class GraphicsProgram3D:
    ...
    def display(self):
        ...
        self.model_matrix.add_scale(0.2, 1.0, 10.0)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
        self.model_matrix.pop_matrix()
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(10.0, 1.0, -3.0)
        self.model_matrix.add_rotate_y(pi/2)
        self.model_matrix.add_scale(0.2, 1, 10.0)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
        self.model_matrix.pop_matrix()
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(11.0, 1.0, 4.1)
        self.model_matrix.add_rotate_y(pi/2)
        self.model_matrix.add_scale(0.2, 1.0, 5.0)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
        self.model_matrix.pop_matrix()
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(13.5, 1.0, 4.5)
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(14.5, 1.0, -1.2)
        self.model_matrix.add_rotate_y(pi/2)
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(14.0, 1.0, -0.7)
        self.model_matrix.add_scale(0.2, 1.0, 3.0)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
        self.model_matrix.pop_matrix()
        ...
        self.shader.set_solid_color(1.0, 0.5, 0.0)
        self.model_matrix.push_matrix()
        self.model_matrix.add_translation(13.3, 1.0, 0.7)
        self.model_matrix.add_rotate_y(pi / 2)
        self.model_matrix.add_scale(0.2, 1.0, 1.5)
        self.shader.set_model_matrix(self.model_matrix.matrix)
        self.cube.draw()
